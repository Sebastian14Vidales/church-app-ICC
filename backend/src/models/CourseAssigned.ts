...
export type CourseAssignedStatus = typeof courseAssignedStatus[keyof typeof courseAssignedStatus];
...
const CourseAssigned = mongoose.model<ICourseAssigned>('CourseAssigned', CourseAssignedSchema);
